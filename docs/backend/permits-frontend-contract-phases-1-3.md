...
**تاريخ:** 22/09/2026 · **أعيد إرساله 23/09/2026 من غير تغيير في المحتوى**

> 📌 **الملف ده بيوصف الإنتاج.** المراحل ٤ و٦ اتبنت بعده على **staging** —
> عقدها في [`permits-frontend-contract-phases-4-6.md`](permits-frontend-contract-phases-4-6.md).
> يعني جدول «مش منفّذة» اللي تحت **لسه صح للإنتاج**، و**مش صح لـstaging**.
