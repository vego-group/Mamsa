...
**التحديث:** v4 — **رجّعنا الخمس بنود اللي فقدتها v3** (§0 و§5)، وأضفنا **مصفوفة الانتقالات** (§1.1). قبلها: v3 = `canReject` والرفض من `approved`؛ v2 = `REFUND_IN_FLIGHT` و`pendingRefundHalalas` والقسم ٤.٢.
