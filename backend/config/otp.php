...
return [
    ...
    // Fixed OTP for NON-PRODUCTION testing, set via OTP_FIXED_CODE. When set and
    // APP_ENV is not "production", every OTP becomes this value — so debug_otp /
    // the SMS log always shows it. Ignored entirely in production (codes stay
    // random). Never write the actual value here or in .env.example: this
    // repository is public, and a committed value is a published credential.
